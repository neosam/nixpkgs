        ...
        locations = {
          ...
          "~ \\.php(?:$|/)" = {
            ...
            extraConfig = ''
              ...
              rewrite ^/(?!index|remote|public|cron|core\/ajax\/update|status|ocs\/v[12]|updater\/.+|oc[s${optionalString (!ocmProviderIsNotAStaticDirAnymore) "m"}]-provider\/.+|.+\/richdocumentscode(_arm64)?\/proxy) /index.php$request_uri;
